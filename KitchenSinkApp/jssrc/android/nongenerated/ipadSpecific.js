...
function onButtonClick() {
    frmPop.setContext({
        widget: frmIpadSplitView.btnContacts,
        anchor: "bottom",
...
function popOverButton(eventObj) {
    ...
    case "Top":
        context = {
            "widget": frmPopOverButton.btnFPB1,
            "anchor": "top",
    ...
    case "Bottom":
        context = {
            "widget": frmPopOverButton.btnFPB2,
            "anchor": "bottom",
            "sizetoanchorwidth": false
        }
        popTopNBottom.setContext(context);
    ...
    case "Left":
        context = {
            "widget": frmPopOverButton.btnFPB3,
            "anchor": "left",
            "sizetoanchorwidth": false
        }
    ...
    case "Right":
        context = {
            "widget": frmPopOverButton.btnFPB4,
            "anchor": "right",
            "sizetoanchorwidth": false
        }
        popLeftNright.setContext(context);
...
function popOverSegment(eventObj) {
    ...
    case 0:
        context = {
            "widget": frmPopOverSegment.segment2117822895630569,
            "anchor": "top",
            "sizetoanchorwidth": false
        }
        popTopNBottom.setContext(context);
