...
function segwidMultiTemplateSPA() {
    frmRowTemplates.segMultiTemp.data = [{
        ...
        lbl1: "For more Info Please Visit ",
        btn1: "xyz.com",
        template: hbxTempSPA1
    }, {
        lbl1: "Gold Card",
        lbl2: "$200",
        lbl3: "$400",
        ...
        lbl1: "Special offers are available on Gold Card",
        template: hbxTempSPA2
    }, {
        lbl1: "Silver Card",
        lbl2: "$200",
        lbl3: "$400",
...
function SecHdrWidoutTemplatesJSSPA() {
    ...
    frmSecHdrWidoutTemplates.segSecHdrWidoutTmplate.data = [
        ...
        [{
            ...
            lblSecHdr3: "Balance $700",
            template: hbxSegHdrTemp2
        }, [{
            BAccName: "Savings 1",
            WithdrawLimit: "$300",
            CreditLimit: "N/A",
...
function orientationSPA(l, m) {
    ...
    alert("l is" + l);
    if (l == "portrait") frmComplex.lblComplex.text = "Please rotate the device to observe Landscape mode";
    else if (l == "landscape") frmComplex.lblComplex.text = "Please rotate the device to observe Portrait mode";
    else {}
}