...
function set3DOSData() {
    ...
    0, 6, 6, 7, 6, 6, 0, 5, 3, 2, 1, 2, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 3, 3, 1, 3, 3, 5, 5, 2, 2, 1, 2, 2, 5]);
    frm3DObj.objectselector3D.setRequiredSelectionsCount(3); //Defining how many objects user can select
    frm3DObj.objectselector3D.setSelectedCells([
        [4, 3],
        [5, 5]
    ]); //pre-defining selected values
    frm3DObj.objectselector3D.setCameraProperties(1.5, 2.5, [
        [1, 4]
    ]); //setting camera properties (while in walk-through mode)
}
/******************************************************************
