...
function segwidMultiTemplate() {
    if (channel == "tablet" || channel == "desktopweb") {
        frmSegmentTablet.segMultiRowTemp.widgetDataMap = {
            lbl1: "lbl1",
            lbl2: "lbl2",
            lbl3: "lbl3"
        }
        ...
        frmRowTemplates.segMultiTemp.widgetDataMap = {
            lbl1: "lbl1",
            lbl2: "lbl2",
            lbl3: "lbl3"
        }
...
function SecHdrTemplatesTab() {
    frmSegmentTablet.segSecHdrTemplates.widgetDataMap = {
        lblSecHdr1: "lblSecHdr1",
        lblSecHdr2: "lblSecHdr2",
    ...
    frmSegmentTablet.segSecHdrTemplates.data = [
        [{
            lblSecHdr1: "Credit account details",
            lblSecHdr2: " Account No: xxxxxx0660",
            template: boxRefSegHdr
        }, [{
            lblBnkAcctName: "Titanium card",
            lblWidDrwLimit: "$200",
            lblCreditLimit: "$400",
            imgChk: "checkboxwhite.png"
        }, {
            lblBnkAcctName: "Gold card",
            lblWidDrwLimit: "$500",
            lblCreditLimit: "$800",
            imgChk: "checkboxwhite.png"
        }, {
            lblBnkAcctName: "Silver card",
            lblWidDrwLimit: "$700",
            lblCreditLimit: "$200",
            imgChk: "checkboxwhite.png"
        }]],
        [{
            lblSecHdr1: "Savings account details",
            lblSecHdr2: " Account No: xxxxxx5221",
            template: boxRefSegHdr1
        }, [{
            lblBnkAcctName: "Savings 1",
            lblWidDrwLimit: "$300",
            lblCreditLimit: "N/A",
            imgChk: "checkboxwhite.png"
        }, {
            lblBnkAcctName: "Savings 2",
            lblWidDrwLimit: "$400",
            lblCreditLimit: "N/A",
            imgChk: "checkboxwhite.png"
        }]],
        [{
            lblSecHdr1: "Checking account details",
            lblSecHdr2: " Account No: xxxxxx7657",
            template: boxRefSegHdr2
        }, [{
            lblBnkAcctName: "Checking 1",
            lblWidDrwLimit: "N/A",
            lblCreditLimit: "$400",
            imgChk: "checkboxwhite.png"
        }, {
            lblBnkAcctName: "Checking 2",
            lblWidDrwLimit: "N/A",
            lblCreditLimit: "$800",
            imgChk: "checkboxwhite.png"
        }]]
...
function segWidoutRowtmplateJS() {
    frmRowTemplates.segWidoutRowtmplate.widgetDataMap = {
        lbl1: "lbl1",
        lbl2: "lbl2",
        lbl3: "lbl3"
    };
...
function segmentSingleSelect(evenObj) {
    frmSegSinleSelect.segSecHdrWidoutTmplate.widgetDataMap = {
        lblSecHdr1: "lblSecHdr1",
        lblSecHdr2: "lblSecHdr2",
        BAccName: "BAccName",
...
function SecHdrWidoutTemplatesJS(evenObj) {
    ...
    frmSecHdrWidoutTemplates.segSecHdrWidoutTmplate.widgetDataMap = {
        lblSecHdr1: "lblSecHdr1",
        lblSecHdr2: "lblSecHdr2",
        BAccName: "BAccName",
        WithdrawLimit: "WithdrawLimit",
...
function androidSegmentSecDock() {
    frmSegSections.segment2117989725237554.data = [
        ["Credit account details", [{
            ...
            lblSegSec1: "Gold card",
            lblSegSec2: "$500",
            lblSegSec3: "$800"
        }, {
            lblSegSec1: "Silver card",
            lblSegSec2: "$700",
            lblSegSec3: "$200"
        }, {
            lblSegSec1: "Silver card",
        ...
        ["Savings account details", [{
            lblSegSec1: "Savings 1",
            lblSegSec2: "$300",
            lblSegSec3: "N/A"
        }, {
            lblSegSec1: "Savings 2",
            lblSegSec2: "$400",
            lblSegSec3: "N/A"
        }, {
            lblSegSec1: "Savings 1",
        ...
        ["Checking account details", [{
            lblSegSec1: "Checking 1",
            lblSegSec2: "N/A",
            lblSegSec3: "$400"
        }, {
            lblSegSec1: "Checking 2",
            lblSegSec2: "N/A",
            lblSegSec3: "$800"
        }, {
            lblSegSec1: "Savings 1",
...
function segwidDictionary() {
    ...
    if (kony.os.deviceInfo().name == "iPad") frmSegDictView.segDictView.setDataWithSections(segdata);
    else frmDictView.segStates.setDataWithSections(segdata);
}
/*****************************************************************
 *	Name    : searchBy
 *	Author  : Kony
...
function multiSelectTab() {
    ...
    for (var i = 0; i < selectedItems.length; i++) {
        arr.push({
            lblBankAcct: selectedItems[i]["lblBnkAcctName"],
            lblWidrawLmt: selectedItems[i]["lblWidDrwLimit"],
            lblCreditLmt: selectedItems[i]["lblCreditLimit"]
        })
    }
    ...
    if (kony.os.deviceInfo().name == "iPad") frmSegmentFeatures.sbxSegmentFeatureDetails.scrollToWidget(frmSegmentTablet.segMultiSelectData);
}
/*****************************************************************
 *	Name    : singleSelect
 *	Author  : Kony
...
function singleSelect() {
    ...
    if (selectedItems == null || selectedItems == "") {
        alert("No item is selected. Please select atleast one item from the above segment");
        return;
    } else alert("Your selection :: " + selectedItems[0]["BAccName"] + "  " + selectedItems[0]["WithdrawLimit"] + "  " + selectedItems[0]["CreditLimit"]);
}
/*****************************************************************
 *	Name    : multiSelect
 *	Author  : Kony
...
function multiSelect() {
    ...
    for (var i = 0; i < selectedItems.length; i++) {
        arr.push({
            lblMulSel1: selectedItems[i]["BAccName"],
            lblMulSel2: selectedItems[i]["WithdrawLimit"],
            lblMulSel3: selectedItems[i]["CreditLimit"]
        })
    }
...
function onEditingIconStyle(seguiWidget, editmode, sectionIndex, rowIndex) {
    if (editmode == 2) seguiWidget.removeAt(rowIndex, sectionIndex);
    else {
        i++;
        var data = {
            cname: "Inserted contact" + i,
            metaInfo: {
...
function dataForSeg(eventObj) {
    ...
    } else eventObj.segStates.setDataWithSections(segdata);
}
/*****************************************************************
 *	Name    : editOrDoneTab
 *	Author  : Kony
...
function refresh(seguiWidget) {
    ...
    } else frmPushPull.segStates.addDataAt(data, 0, j);
    j++;
}
/*****************************************************************
 *	Name    : callService
...
function scrollEnd() {
    ...
    if (countORE < displayData.length) {
        ...
        if (countORE > 0) frmSegOnReachEnd.segRecords.removeAt(countORE, 0);
        frmSegOnReachEnd.segRecords.addAll(currentData);
        if (max != displayData.length) frmSegOnReachEnd.segRecords.addDataAt({
            "lblLoadingORE": "Loading...",
            template: hbxLoadORE
        }, max, 0)
        countORE = max;
    }
