...
function unRegisterAccEvent() {
    ...
    if (channel != "tablet") frmAclmeterOptions.show();
}
/******************************************************************
...
function onsuccesscallbackretCurrentAcc(accelerometerdata) {
    ...
    if (channel == "tablet") frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.hbxAcceleromterReadings);
    else frmAclMeterReadings.show();
}
/*****************************************************************
...
function retrieveCurrentAcc() {
    if (channel == "tablet") frmDeviceFeatures.sbxDevFeatureDeatils.removeAt(1);
...
function onsuccesscallbackstartmonitoringAcc(startmonitoringdata) {
    ...
    if (channel != "tablet") frmAclMeterReadings.show();
}
/******************************************************************
