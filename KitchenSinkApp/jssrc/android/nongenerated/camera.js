...
function onCaptureFrmOverLayTab(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "android" && kony.os.deviceInfo().name != "iPad") frmCameraFrmOverlay.show();
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
 *	Name    : onCaptureTab
...
function onCaptureFrmOverLay(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "android") frmCameraFrmOverlay.show();
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
...
function onCapturePrivate(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "iPhone") frmCamAcsModes.lblFrmCamAccessModes.text = "Second image from left is the captured image in private mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
    else frmCamAcsModes.lblFrmCamAccessModes.text = "First image from left is the captured image in private mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
...
function onCaptureinMemory(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "iPhone") frmCamAcsModes.lblFrmCamAccessModes.text = "Third image from left is the captured image in inMemory mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
    else frmCamAcsModes.lblFrmCamAccessModes.text = "Second image from left is the captured image in inMemory mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
