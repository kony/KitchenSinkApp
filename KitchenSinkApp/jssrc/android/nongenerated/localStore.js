...
function getItemvalues() {
    if ((kony.os.deviceInfo().name == "thinclient" && channel == "tablet") || channel == "desktopweb") {
        if (frmDeviceFeatures.frmLocalTxtGet1.text == "" || frmDeviceFeatures.frmLocalTxtGet1.text == null) {
            ...
            return;
        } else var key = frmDeviceFeatures.frmLocalTxtGet1.text;
        var value = kony.store.getItem(key);
        if ((value != null)) frmDeviceFeatures.frmLocalLblGet1.text = "" + value;
        else frmDeviceFeatures.frmLocalLblGet1.text = "Key is not found";
    } else {
...
function GetKey() {
    ...
    if (index == "" || index == null) {
        ...
        return;
    } else var key = kony.store.key(kony.decrement(kony.os.toNumber(index)));
