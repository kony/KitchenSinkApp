...
function onWidgetCatBtnsClick(btnId) {
    if (btnId == "btnContainerWidTab") {
        if (frmUInterface.segContainerWidgets.isVisible == true) frmUInterface.segContainerWidgets.setVisibility(false);
        else frmUInterface.segContainerWidgets.setVisibility(true);
        ...
        if (frmUInterface.segBasicWidgets.isVisible == true) frmUInterface.segBasicWidgets.setVisibility(false);
        else frmUInterface.segBasicWidgets.setVisibility(true);
        //alert(" visibility is :: "+frmUInterface.segBasicWidgets.isVisible);
        frmUInterface.segContainerWidgets.setVisibility(false);
        frmUInterface.segAdvancedWidgets.setVisibility(false);
    } else {
        if (frmUInterface.segAdvancedWidgets.isVisible == true) frmUInterface.segAdvancedWidgets.setVisibility(false);
        else frmUInterface.segAdvancedWidgets.setVisibility(true);
        frmUInterface.segContainerWidgets.setVisibility(false);
        frmUInterface.segBasicWidgets.setVisibility(false);
    }
}
...
function tabAdvancedWidgets(selIndex) {
    ...
    case 2:
        ...
        if (kony.os.deviceInfo().name != "thinclient") frmImgStrip.lblhIS.text = "No image selected";
        frmUInterface.sbxWidgetDetails.add(frmImgStrip.hbxImgStrips);
        break;
    case 3:
        frmMap.addWidgets();
        if (kony.os.deviceInfo().name == "thinclient") setLocationData();
    ...
    case 5:
        ...
        if (kony.os.deviceInfo().name != "thinclient") frmUInterface.sbxWidgetDetails.add(frmSwitch.hbxSwitch);
        break;
    case 6:
        frmPickerView.addWidgets();
        if (kony.os.deviceInfo().name != "thinclient") frmUInterface.sbxWidgetDetails.add(frmPickerView.hbxPickerViewTablet);
        break;
    }
}
/*****************************************************************
...
function tabBasicWidgets(selIndex) {
    ...
    case 5:
        frmImage.addWidgets();
        if (kony.os.deviceInfo().name == "thinclient") frmUInterface.sbxWidgetDetails.add(frmImage.hbxFitToDimensions, frmImage.hbxMaintainAspectRatio, frmImage.hbxURLBasedImages);
        else frmUInterface.sbxWidgetDetails.add(frmImage.hbxFitToDimensions, frmImage.hbxMaintainAspectRatio, frmImage.hbxCrop, frmImage.hbxURLBasedImages);
        break;
    case 6:
...
function tabContainerWidgets(selIndex) {
    ...
    case 1:
        ...
        } else frmUInterface.sbxWidgetDetails.add(frmTabPane.hbxDefaultTbpTab, frmTabPane.hbxCollapseTbpTab, frmTabPane.hbxToggleTbpTab, frmTabPane.hbxImgPosTbpTab, frmTabPane.hbxPageTbpTab);
        break;
    case 2:
...
function tabUIHandle(segment) {
    ...
    if (kony.os.deviceInfo().name != "thinclient") frmUInterface.sbxWidgetDetails.scrollToBeginning();
    var segId = segment.id;
    kony.print("segment ID is :: " + segId);
    if (segId == "segContainerWidgets") tabContainerWidgets(frmUInterface.segContainerWidgets.selectedIndex[1]);
    else if (segId == "segBasicWidgets") tabBasicWidgets(frmUInterface.segBasicWidgets.selectedIndex[1]);
    else tabAdvancedWidgets(frmUInterface.segAdvancedWidgets.selectedIndex[1]);
}
/*****************************************************************
