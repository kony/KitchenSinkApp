...
function deviceInfo() {
    ...
    if (deviceInfo.name == "android") {
        details.push({
            lblKey: "Device ID",
            lblVal: "" + deviceInfo.deviceid
        });
        details.push({
            lblKey: "Name",
            lblVal: "" + deviceInfo.name
        });
        details.push({
            lblKey: "Model",
            lblVal: "" + deviceInfo.model
        });
        details.push({
            lblKey: "APILevel",
            lblVal: "" + deviceInfo.APILevel
        });
        details.push({
            lblKey: "Version",
            lblVal: "" + deviceInfo.version
        });
        details.push({
            lblKey: "OS Version",
            lblVal: "" + deviceInfo.osversion
        });
        details.push({
            lblKey: "DeviceWidth",
            lblVal: "" + deviceInfo.deviceWidth
        });
        details.push({
            lblKey: "DeviceHeight",
            lblVal: "" + deviceInfo.deviceHeight
        });
        details.push({
            lblKey: "FreeMemory",
