...
function home() {
    ...
    case 1:
        ...
        } else if (kony.os.deviceInfo().name == "WindowsPhone") frmAniWin.show();
        else if (kony.os.deviceInfo().name == "android") frmAniAnd.show();
        else if (kony.os.deviceInfo().name == "thinclient") frmAniSPA.show();
        else if (kony.os.deviceInfo().name == "Windows 8") alert("Not Applicable for windows 8");
        else frmAni.show();
        break;
    case 2:
        frmDvcFeatures.show();
...
function uICategory() {
    ...
    case 2:
        ...
        break;
    case 3:
        if (kony.os.deviceInfo().name == "iPad") frmIpadSpecificFeatures.show();
        else alert("These features specific to IPad only")
        break;
    }
}
/*****************************************************************
