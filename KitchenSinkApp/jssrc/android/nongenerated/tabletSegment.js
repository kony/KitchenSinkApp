...
function dataForSegTab(eventObj) {
    ...
    if ('segPullToRefresh' in eventObj) eventObj.segPullToRefresh.setDataWithSections(segdata);
}
/*****************************************************************
...
function tabSegmentFeaturesHandle(selIndex) {
    ...
    if (kony.os.deviceInfo().name != "thinclient") frmSegmentFeatures.sbxSegmentFeatureDetails.scrollToBeginning();
    kony.print("selected Index is " + selIndex);
    switch (selIndex) {
    case 0:
        if (kony.os.deviceInfo().name == "thinclient") frmSegmentTablet.addWidgets();
    ...
    case 7:
        if (channel == "tablet" && kony.os.deviceInfo().name == "Windows") {
            ...
            rowTempSetData();
            frmSegmentFeatures.sbxSegmentFeatureDetails.add(frmSegDynRowTemplate.segDynamicRowTemp);
        } else if (channel == "tablet" && kony.os.deviceInfo().name == "android") frmSegmentFeatures.sbxSegmentFeatureDetails.add(frmSegDynRowTemplate.segDynamicRowTemp);
        else frmSegmentFeatures.sbxSegmentFeatureDetails.add(frmSegmentTablet.btnEditOrDone, frmSegmentTablet.segIconEditStyle);
        break;
    case 8:
...
function tabSegmentViewsHandle(selIndex) {
    ...
    if (kony.os.deviceInfo().name != "thinclient") frmSegmentViews.sbxSegmentViewDetails.scrollToBeginning();
    kony.print("selected Index is " + selIndex);
    switch (selIndex) {
    case 0:
