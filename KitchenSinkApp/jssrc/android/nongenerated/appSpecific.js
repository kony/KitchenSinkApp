	...
	function onGestureFunction(commonWidget, gestureInfo) // The callback function when the gesture event is triggered.
	{
	    ...
	    try {
	        ...
	        {
	            if (kony.os.deviceInfo().name == "thinclient" && channel != "tablet" && channel != "desktopweb") frmGestures.lblGesture.text = "A Double tap gesture was performed.";
	            else if (channel == "tablet" || channel == "desktopweb") frmGestures.lblGestureInfo.text = "A Double tap gesture was performed.";
	        ...
	        } else if (GesType == "2") //Swipe gesture
	        {
	            ...
	            if (kony.os.deviceInfo().name == "thinclient" && channel != "tablet" && channel != "desktopweb") frmGestures.lblGesture.text = "A swipe gesture was performed in the " + direction + " direction.";
	            else if (channel == "tablet" || channel == "desktopweb") frmGestures.lblGestureInfo.text = "A swipe gesture was performed in the " + direction + " direction.";
	        } else if (GesType == "3") {
	            if (kony.os.deviceInfo().name == "thinclient" && channel != "tablet" && channel != "desktopweb") frmGestures.lblGesture.text = "A longpress gesture was performed";
	            else if (channel == "tablet" || channel == "desktopweb") frmGestures.lblGestureInfo.text = "A longpress gesture was performed";
	...
	function hIS(eventobj) {
	    ...
	    if (focIn == 0) frmImgStrip.lblhIS.text = "First Image is selected";
	    else if (focIn == 1) frmImgStrip.lblhIS.text = "Second Image is selected";
	    else if (focIn == 2) frmImgStrip.lblhIS.text = "Third Image is selected";
	    else if (focIn == 3) frmImgStrip.lblhIS.text = "Fourth Image is selected";
	    else if (focIn == 4) frmImgStrip.lblhIS.text = "Fifth Image is selected";
	    else if (focIn == 5) frmImgStrip.lblhIS.text = "Sixth Image is selected";
	    else if (focIn == 6) frmImgStrip.lblhIS.text = "Seventh Image is selected";
	    else {}
	}
	/*****************************************************************
	 *	Name    : setBadge
	...
	function createAppMenu() {
	    ...
	    //Animation
	    if (kony.os.deviceInfo().name == "thinclient" && channel != "tablet" && channel != "desktopweb") var animationMItem = ["animationId", "Animation", "app_animation.png", function aniMenuCallBack() {
	        frmAniSPA.show()
	    }];
	    else if (channel == "mobile" && kony.os.deviceInfo().name == "android") var animationMItem = ["animationId", "Animation", "app_animation.png", function aniMenuCallBack() {
	        frmAniAnd.show()
	    }];
	    else if (channel == "tablet" || channel == "desktopweb") var animationMItem = ["animationId", "Animation", "app_animation.png", function aniMenuCallBack() {
	        frmAnimations.show()
	    }];
	    else if (channel == "mobile" && kony.os.deviceInfo().name == "WindowsPhone") var animationMItem = ["animationId", "Animation", "app_animation.png", function aniMenuCallBack() {
	        frmAniWin.show()
	    }];
	    else var animationMItem = ["animationId", "Animation", "app_animation.png", function aniMenuCallBack() {
	        frmAni.show()
	    }];
	    //Home	
	    var homeMItem = ["homeId", "Home", "app_home.png", function homeMenuCallBack() {
	        frmHome.show()
	    }];
	    //Exit
	    if (kony.os.deviceInfo().name != "thinclient") var closeMItem = ["closeId", "Close", "app_close.png", function closeMenuCallBack() {
	        kony.application.exit()
	    }];
	    //DeviceFeatures	
	    if (channel == "tablet" || channel == "desktopweb") var featuresMItem = ["featuresId", "Features", "app_features.png", function featuresMenuCallBack() {
	        frmDeviceFeatures.show()
	    }];
	    else var featuresMItem = ["featuresId", "Features", "app_features.png", function featuresMenuCallBack() {
	        frmDvcFeatures.show()
	    }];
	    //UI Interface	
	    if (channel == "tablet" || channel == "desktopweb") var uiMItem = ["uiId", "UI", "app_ui.png", function uiMenuCallBack() {
	        frmUInterface.show()
	    }];
	    else var uiMItem = ["uiId", "UI", "app_ui.png", function uiMenuCallBack() {
	        frmUICategory.show()
	    }];
	    //Defining app menu
	    if (channel == "mobile" && kony.os.deviceInfo().name == "WindowsPhone") var appMenu = [homeMItem, animationMItem, featuresMItem, closeMItem];
	    else if (kony.os.deviceInfo().name == "thinclient") var appMenu = [homeMItem, uiMItem, animationMItem, featuresMItem];
	    else if (kony.os.deviceInfo().name == "Windows" && channel == "tablet") var appMenu = [homeMItem, uiMItem, featuresMItem, closeMItem];
	    else var appMenu = [homeMItem, uiMItem, animationMItem, featuresMItem, closeMItem];
	    //Creating app menu	
