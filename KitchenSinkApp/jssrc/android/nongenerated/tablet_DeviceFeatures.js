...
function tabDevcFeatsHandleIpad(selIndex) {
    ...
    if (kony.os.deviceInfo().name != "thinclient") frmDeviceFeatures.sbxDevFeatureDeatils.scrollToBeginning();
    kony.print("selected Index is " + selIndex);
    switch (selIndex) {
    case 0:
        if (kony.os.deviceInfo().model == "iPad Simulator") frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.lblEmulatorSupport);
        else frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.hbxAccelerometerOptions);
        break;
    case 1:
        setBadge();
    ...
    case 3:
        if (kony.os.deviceInfo().model == "iPad Simulator") frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.lblEmulatorSupport);
        else frmDeviceFeatures.sbxDevFeatureDeatils.add(frmCamera.hbxCameraBasic, frmCamera.hbxFrmOverlay, frmCamera.hbxCameraAccessModes, frmCamera.hbxCamOrientationMode)
        break;
    case 4:
        geoPosition();
...
function tabDevcFeatsHandleWinTab(selIndex) {
    ...
    switch (selIndex) {
    case 0:
        if (kony.os.hasAccelerometerSupport() == false) frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.lblEmulatorSupport);
        else frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.hbxAccelerometerOptions);
        break;
    case 1:
        if (kony.os.hasAccelerometerSupport() == false) frmDeviceFeatures.sbxDevFeatureDeatils.add(frmAclMeterReadings.lblEmulatorSupport);
        else frmDeviceFeatures.sbxDevFeatureDeatils.add(frmCamera.hbxCameraBasic, frmCamera.hbxCameraAccessModes);
        break;
    case 2:
        geoPosition();
        break;
