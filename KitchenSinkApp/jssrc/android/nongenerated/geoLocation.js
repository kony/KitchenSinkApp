...
function geoSuccessCallBack(position) {
    if ((channel == "tablet" || channel == "desktopweb") && kony.os.deviceInfo().name == "thinclient") frmGeoCurrentNWatch.addWidgets();
    try {
    ...
    if (channel != "tablet" && channel != "desktopweb") frmGeoCurrentNWatch.show();
    else if ((channel == "tablet" || channel == "desktopweb") && kony.os.deviceInfo().name == "thinclient") frmDeviceFeatures.sbxDevFeatureDeatils.add(frmGeoCurrentNWatch.hbxGeoLocation);
    else frmDeviceFeatures.sbxDevFeatureDeatils.add(frmGeoCurrentNWatch.hbxGeoLocation);
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
