//Form JS File
function frmNList_segFirst_onRowClick_seq0(eventobject, sectionNumber, rowNumber) {
    frmNLst2.show();
};
...
function addWidgetsfrmNList() {
    ...
    var segFirst = new kony.ui.SegmentedUI2({
        ...
        "onRowClick": frmNList_segFirst_onRowClick_seq0,
    ...
    hbox192822373931789.add(
    lblFirst, image2192822373931790);
    segFirstbox.add(
    hbox192822373931789);
    frmNList.add(
    segFirst);
